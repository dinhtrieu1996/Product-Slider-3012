...
var variant_id = $(this).parents('.simesy-product-item').find('.simesy-select-variant').val();
$.ajax({
url: "/cart/add.js",
dataType: "json",
type: "post",
...
var add_to_cart_button_text = window.simesy_product_slider && window.simesy_product_slider.translations && window.simesy_product_slider.translations.add_to_cart_button_text ? window.simesy_product_slider.translations.add_to_cart_button_text : "Add to cart";
var read_more_button_text = window.simesy_product_slider && window.simesy_product_slider.translations && window.simesy_product_slider.translations.read_more_button_text ? window.simesy_product_slider.translations.read_more_button_text : "Read more";
...
var css = "";
// Slick Style
config["slider_section_full_width"] = false;
config["slider_section_max_width"] = 1000;
config["show_variants_selector"] = true;
if(!config.slider_section_full_width){
css+= `#simesy-slider-section.simesy-slider-section{
max-width:${config.slider_section_max_width}px;
      width:100%;
    }`
}
...
if(config.filter_products == 'related'){
  ...
  $.each(config.product,function(i,item){
    $.ajax({
      async:false,
      url:'/products/'+item.handle+'?view=simesy-product-slider',
      success:function(data){
